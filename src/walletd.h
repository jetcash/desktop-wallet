...
public:
    ...
    {
        JETCASHD_DATABASE_ERROR = 101, // we hope we are out of diskspace, otherwise blockchain.db is corrupted
        JETCASHD_ALREADY_RUNNING = 102,
        WALLETD_BIND_PORT_IN_USE = 103,
        JETCASHD_BIND_PORT_IN_USE = 104,

...
constexpr const char* CURRENCY_TICKER = "JTC";
constexpr const uint64_t MAXIMUM_UNSYNCED_BLOCKS_WHEN_SEND_AVAILABLE = 5;
constexpr const uint64_t COIN = 100000000000;
constexpr const uint32_t CONFIRMATIONS = 3;
constexpr const int NUMBER_OF_DECIMAL_PLACES = 11;
...
constexpr const uint16_t RPC_DEFAULT_PORT = 12010;

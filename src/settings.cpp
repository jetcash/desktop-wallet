...
constexpr quint16 DEFAULT_LOCAL_RPC_PORT = 12010;
constexpr char LOCAL_HOST[] = "127.0.0.1";

#if defined(Q_OS_LINUX)
constexpr char DEFAULT_WORK_DIR[] = ".jetcash";
#endif

const constexpr char* DEFAULT_MINING_POOLS[] = { "pool.jetcash.org:3333" };
...
Settings::Settings()
{
    ...
    const QString jsonFile = getDefaultWorkDir().absoluteFilePath("jetwallet.config");

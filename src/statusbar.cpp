...
//    , m_encryptionStatusIconLabel(new QLabel(this))
    ...
    , m_jetcashdConnectionLabel(new QLabel(this))
...
//    m_encryptionStatusIconLabel->setObjectName("m_encryptionStatusIconLabel");
    ...
    addPermanentWidget(m_jetcashdConnectionLabel);
...
void WalletStatusBar::setWalletModel(WalletModel* model)
{
    ...
    stateMapper_->addMapping(m_jetcashdConnectionLabel, WalletModel::COLUMN_LOWER_LEVEL_ERROR, "text");
